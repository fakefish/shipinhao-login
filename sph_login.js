...
function createQRCode(login_token) {
    const url = "https://channels.weixin.qq.com/mobile/confirm_login.html?token=" + login_token
...
function checkLoginStatus(userAgent, loginToken) {
    const requestUrl = "https://channels.weixin.qq.com/cgi-bin/mmfinderassistant-bin/auth/auth_login_status";
    ...
    return new Promise((resolve, reject) => {
        function checkStatus() {
            ...
            axios.post(requestUrl, {}, { headers: headers, params: requestParams })
                .then(response => {
                    const jsonObj = response.data;
